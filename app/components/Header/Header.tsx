...
import { BookishLogo, DropDownIcon, DropDownIconDown, UserProfile } from "@/app/assets/icons/config";
    ...
    <header className={styles.header}>
      ...
      <div className={styles.headerMain}>
        <div className={styles.userProfile}>
          <Image src={UserProfile} width={32} height={32} alt="User Profile"></Image>
